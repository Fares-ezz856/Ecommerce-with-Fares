          ...
          <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ route('admin.getusers') }}">users</a>
            ...
            <!-- Nav Item - Utilities Collapse Menu -->
               <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{ route('admin.getallorders') }}">Order</a>
...
<tbody>
    {{-- التكرار على الطلبات الأساسية --}}
    @foreach ($orders as $order)
      {{-- التكرار على تفاصيل الطلب (المنتجات) الخاصة بالطلب الحالي فقط --}}
      {{-- نفترض أن العلاقة اسمها 'details' أو 'order_items' في موديل Order --}}
      @foreach ($order->details as $detail)
        <tr>
          ...
          <td>{{ $order->address }}</td>
          <td>{{ $order->phone }}</td>
          {{-- اسم المنتج من الـ detail --}}
          <td>{{ $detail->product?->name ?? 'منتج غير موجود' }}</td>
          <td>{{ $detail->price }}</td>
          <td>{{ $order->note }}</td>
        </tr>
      @endforeach
