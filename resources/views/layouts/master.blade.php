							...
							<ul>
								...
								<li ><a href="/">الرئيسية</a>
                                    @if (Auth::user()&&Auth::user()->role=='admin')
                                        <li ><a href="/admin/index">لوحة التحكم</a>
                                    @endif

								</li>
								<li><a href="/product">المنتجات</a></li>
                                <li><a href="/ajax-offers/offers">العروض</a></li>
                                <li><a href="/category">الأقسام</a></li>
                                @if (Auth::user()&&Auth::user()->role=='admin')
                                <li><a href="/add_product">اضافة منتج</a></li>
                                <li><a href="/ajax-offers/insert">اضافة عرض</a></li>
                                <li><a href="/add_category">اضافة قسم</a></li>
                                @endif
                                ...
                                @if (Route::has('register'))
                                    <li>
                                        <a href="{{ route('register') }}">{{ __('انشاء حساب') }}</a>
                                    </li>
                                @endif
                            @else
                                <li>
					...
					<div class="col-lg-10 offset-lg-1 text-right">
						<div class="hero-text">
							<div class="hero-text-tablecell">
								...
								<h1>خصومات لانهائية على جميع المنتجات</h1>
								<div class="hero-btns">
									<a href="shop.html" class="boxed-btn">سجل معنا</a>
									<a href="contact.html" class="bordered-btn">تواصل معنا</a>
								</div>
...
<form action="{{ route('changelanguage','ar') }}" method="post">
    ...
    <form action="{{ route('changelanguage') }}" method="post">
        ...
        <select name="locale" onchange="this.form.submit()">
            ...
            <option value="ar" {{ session('locale') == 'ar' ? 'selected' : '' }}>عربى</option>
        </select>
    </form>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6 col-md-12">
					<p>Copyrights &copy; 2024 - <a href="https://imransdesign.com/">Fares Aboelezz</a>
					</p>
				</div>
